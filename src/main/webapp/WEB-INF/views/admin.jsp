                ...
                <form method="post" action="/root/admin">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${userFromBase.getRoleString() ne 'operator'}">
                                <button class="btn-link" value="operator" name="command"><span
                                        class="glyphicon glyphicon-briefcase"></span> make operator
                                </button>
                            </c:if>
